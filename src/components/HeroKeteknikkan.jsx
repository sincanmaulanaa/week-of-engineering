  ...
  return (
    ...
    >
      <div className='w-full md:w-[800px] xl:w-[900px] flex flex-col justify-center items-center pt-24 md:pt-16 lg:pt-20 text-center'>
        ...
        >
          <div className='text-5xl sm:text-6xl lg:text-7xl xl:text-7xl font-bold tracking-wide  text-slate-800  px-8 sm:px-8 md:px-20 lg:px-4'>
            <span className='inline md:hidden'>⚙️ KETEKNIKAN ⚙️</span>
            <span className='hidden md:inline'>⚙️ KETEKNIKAN ⚙️</span>
          </div>
          <div className='mt-2 sm:mt-2 text-5xl sm:text-7xl lg:text-7xl xl:text-7xl font-bold tracking-wide  text-slate-800 px-8 sm:px-20 md:px-24 lg:px-0'>
            COMPETITION
            <br />
